...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    prod_z_axis<<0,-1,0,
                 1, 0,0,
                 0, 0,0;
    rotation_model=cos(rotation_rad)*rotation_model+(1-cos(rotation_rad))*z_axis*z_axis.transpose()+sin(rotation_rad)*prod_z_axis;
...
Eigen::Matrix4f get_rotation(Eigen::Vector3f axis,float angle)
{
    ...
    float rotation_rad = acos(-1)*(angle)/180.f;
    ...
    cross_prod_axis<<0,-axis.z(),axis.y(),
                 axis.z(),0,-axis.x(),
                 -axis.y(),axis.x(),0;
    rotation_model =cos(rotation_rad)*rotation_model+(1-cos(rotation_rad))*axis*axis.transpose()+sin(rotation_rad)*cross_prod_axis;
