...
static bool isSameSide(const Eigen::Vector3f& pt1,const Eigen::Vector3f& pt2,const Eigen::Vector3f& a,const Eigen::Vector3f&b)
{
...
{
    auto ind = (height -1-point.y())+point.x()*width;
    frame_buf[ind]+=color;
}
